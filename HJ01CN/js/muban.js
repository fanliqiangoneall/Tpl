...
$(function () {
    $('#index_newslist').slick({infinite: true, slidesToShow: 3, slidesToScroll: 1, lazyLoad: 'ondemand',dots: true,});
...
jQuery(function () {
    ...
    jQuery("#main-menu ul li a").each(function () {
		...
		//当前url
        if (href == url) {
            jQuery(this).parents(".nav_li").addClass("menu_on");
			return false;
        }else{
         ...
         /*else {
            ...
            if (url.indexOf("product") != -1) {
                if (href.indexOf("product") != -1 && href.indexOf("product_category")==-1) {
                    jQuery(this).parent("li").addClass("menu_on")
                }
            }
