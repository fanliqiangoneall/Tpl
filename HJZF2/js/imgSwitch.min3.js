...
define(function(){
	...
	setOptions:function(options){
		...
		this.options={
			...
			Pause:3000,//锟斤拷停锟斤拷时锟斤�?
			Type:1,//锟斤拷锟斤拷锟斤拷锟斤拷
			Navigate:"numberic",//锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟街ｏ拷锟街憋拷为no(锟斤�?),numberic(锟斤拷锟斤拷),picture(图片)
			Width:874,//图片锟侥匡拷锟斤�?
			Height:211,//图片锟侥高讹�?
			Speed:"normal",//转锟斤拷锟斤拷俣�??
	...
	timeLine:function(play,end,len){
		...
		c = function(f,t){return +f+(t-f)*(s>1?s-Math.floor(s)==0?1:s-Math.floor(s):s)};//锟斤拷锟斤拷t锟斤拷锟斤拷确锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷�?�锟缴达拷锟叫★拷锟斤拷锟斤拷锟叫★拷锟斤拷
	...
	fxs:[
		function(el,x){this.clipDiv(el,x(this.maskHeight,0),x(0,this.maskWidth),x(0,this.maskHeight),x(this.maskWidth,0))},//锟斤拷锟较诧拷锟捷硷拷锟斤拷锟斤拷锟铰诧拷锟斤拷锟斤�?
