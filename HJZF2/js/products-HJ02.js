require(['swiper','jquery'],function(Swiper,$){
        var swiper_pro = new Swiper('.new_hjzf_products-HJ02 .index_pro_slickbox', {
            slidesPerView: 3,
            spaceBetween: 30,
            loop: true,
            autoplay:true,
    ...
    $(document).ready(function(){
        ...
        var index_prolist_wai_height = $(".new_hjzf_products-HJ02 .index_prolist_waibox").height();
        $(".new_hjzf_products-HJ02 .index_prolist_wai").css("height",index_prolist_wai_height);
    })
});
