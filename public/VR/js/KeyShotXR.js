...
window.keyshotXR = function(U, v, V, W, pa, D, qa, ra, sa, ta, ua, J, K, X, Y, va, Z, wa, $, xa, aa, ya, za, Aa, Ba, p ,iconbg,iconwidth,loadingwidth) {
    ...
    this.Ua = function() {
        a.u(!a.l);
        a.l ? a.H.setAttribute("src",TMPL+"public/VR/img/GoFullScreenIcon.png") : a.H.setAttribute("src",TMPL+"public/VR/img/GoFixedSizeIcon.png");
	};
    this.u = function(b) {
        a.l = b;
    ...
    this.ta = function() {
        ...
        a.o.innerHTML = '<img src="'+TMPL+'public/VR/img/'+ c + '"></img>';
        a.p.appendChild(a.o);
        a.p.appendChild(a.Q);
        n.appendChild(a.p);
        a.u(a.l);
    ...
    if (document.createElement("canvas").getContext) {
        ...
        wa && (a.S = document.createElement("div"), b = "position:absolute;", b += "width: "+iconwidth+"px;", b += "height: "+iconwidth+"px;", b += y + "transform-origin: 50% 50%;", b += "visibility: hidden;", b += "cursor: pointer;", b += "background:"+iconbg+";border-radius:20px;", a.S.setAttribute("style", b), a.H = document.createElement("img"), a.l ? a.H.setAttribute("src", TMPL+"public/VR/img/GoFullScreenIcon.png") : a.H.setAttribute("src",  TMPL+"public/VR/img/GoFixedSizeIcon.png"), a.H.setAttribute("style", "position: absolute;top: 0px;left: 0px;width: "+(iconwidth*0.5)+"px;height: "+(iconwidth*0.5)+"px;margin-top:"+(iconwidth*0.25)+"px;margin-left:"+(iconwidth*0.25)+"px;"), a.S.appendChild(a.H), a.S.V = function(a, b) {
			//
		...
		a.S1 = document.createElement("div"), b1 = "position:absolute;", b1 += "width: "+iconwidth+"px;", b1 += "height: "+iconwidth+"px;", b1 += y + "transform-origin: 50% 50%;", b1 += "visibility: inherit;", b1 += "cursor: pointer;", b1 += "background:"+iconbg+";border-radius:20px;", a.S1.setAttribute("style", b1),a.S1.setAttribute("id", "imgbig"), a.H1 = document.createElement("img"), a.H1.setAttribute("src", TMPL+"public/VR/img/imgbig.png") , a.H1.setAttribute("style", "position: absolute;top: 0px;left: 0px;width: "+(iconwidth*0.5)+"px;height: "+(iconwidth*0.5)+"px;margin-top:"+(iconwidth*0.25)+"px;margin-left:"+(iconwidth*0.25)+"px;"), a.S1.appendChild(a.H1), a.S1.V = function(a, b) {
			//
		...
		a.S3 = document.createElement("div"), b3 = "position:absolute;", b3 += "width: "+(iconwidth*2)+"px;", b3 += "height: "+(iconwidth*1.5)+"px;", b3 += y + "transform-origin: 50% 50%;", b3 += "visibility: inherit;", b3 += "cursor: pointer;", a.S3.setAttribute("style", b3), a.H3 = document.createElement("img"), a.H3.setAttribute("src", TMPL+"public/VR/img/360icon.png") , a.H3.setAttribute("style", "position: absolute;top: 0px;left: 0px;width: "+(iconwidth*2)+"px;height: "+(iconwidth*1.5)+"px"), a.S3.appendChild(a.H3), a.S3.V = function(a, b) {
			//
