...
arrowimages: {down:['downarrowclass', 'down.gif', 0], right:['rightarrowclass', '../internet/images/right.gif']},
...
buildmenu:function($, setting){
	...
	$headers.each(function(i){ //loop through each LI header
		...
		$subul.css({top:this.istopheader && setting.orientation!='v'? (this._dimensions.h-30)+"px" : 0})
