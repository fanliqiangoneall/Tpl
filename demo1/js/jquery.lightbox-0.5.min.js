 ...
 */
(function($){$.fn.lightBox=function(settings){settings=jQuery.extend({overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'/www/Tpl/img/lightbox-ico-loading.gif',imageBtnPrev:'/www/Tpl/img/lightbox-btn-prev.gif',imageBtnNext:'/www/Tpl/img/lightbox-btn-next.gif',imageBtnClose:'/www/Tpl/img/lightbox-btn-close.gif',imageBlank:'/www/Tpl/img/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
