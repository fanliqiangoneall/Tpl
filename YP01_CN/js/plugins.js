(function($) { !
    ...
    function(t, e, o, i) {
            ...
            this._handlers = {
                "initialized.owl.carousel change.owl.carousel": t.proxy(function(e) {
                    if (e.namespace && this._core.settings && !1 !== this._core.settings.lazyLoad && (e.property && "position" === e.property.name || "initialized" === e.type)) {
                        ...
                        this);
                        for (console.log(); s--;) this.load(r / 2 + i[s]),
        ...
        r.prototype.positions = function(t) {
            for (var e = [], o = this._core.settings, i = this._core.relative(t), r = o.loop || o.center && i > 0, s = o.center && (i > 0 || o.loop), n = o.items + (s && o.items % 2 == 0 ? 1 : 0), a = "page" === o.lazyPrefetch ? n: o.lazyPrefetch, l = n, c = s ? -Math.ceil(o.items / 2) : 0; a--;) r && e.unshift(this._core.relative(t - a + c - 1)),
        ...
        r.prototype.load = function(o) {
            ...
            r = i && i.find(".owl-lazy"); ! r || t.inArray(i.get(0), this._loaded) > -1 || (r.each(t.proxy(function(o, i) {
                var r = t(i),
                ...
                r.is("img") ? r.one("load.owl.lazy", t.proxy(function() {
                    ...
                    "lazy"),
                    this._core.settings.autoWidth && (this._core.invalidate("width"), this._core.update())
                },
    ...
    function(t) {
        ...
        function e(t, e) {
            ...
            x && x.state !== e && (s(x, "display", e ? "none": ""), e || x.state && (t.options.group.revertClone ? (N.insertBefore(x, k), t._animate(C, x)) : N.insertBefore(x, C)), x.state = e)
        }
        function n(t, e, n) {
            if (t) {
                n = n || Q;
        ...
        function s(t, e, n) {
            var o = t && t.style;
            if (o) {
                if (void 0 === n) return Q.defaultView && Q.defaultView.getComputedStyle ? n = Q.defaultView.getComputedStyle(t, "") : t.currentStyle && (n = t.currentStyle),
                void 0 === e ? n: n[e];
                e in o || (e = "-webkit-" + e),
        ...
        st = _(function(t, e, n) {
            if (n && e.scroll) {
                ...
                Y && (o = Y, i = Y.getBoundingClientRect(), r = (it(i.right - u) <= d) - (it(i.left - u) <= d), a = (it(i.bottom - f) <= d) - (it(i.top - f) <= d)),
                r || a || (a = (g - f <= d) - (f <= d), ((r = (p - u <= d) - (u <= d)) || a) && (o = G)),
                W.vx === r && W.vy === a && W.el === o || (W.el = o, W.vx = r, W.vy = a, clearInterval(W.pid), o && (W.pid = setInterval(function() {
        ...
        t.prototype = {
            ...
            _onTapStart: function(t) {
                ...
                if (y(i), !C && !(/mousedown|pointerdown/.test(l) && 0 !== t.button || r.disabled) && !h.isContentEditable && (c = n(c, r.draggable, i)) && B !== c) {
                    if (e = v(c, r.draggable), "function" == typeof u) {
                        if (u.call(this, t, c, this)) return d(o, h, "filter", c, i, i, e),
                        void(a && t.preventDefault())
                    } else if (u && (u = u.split(",").some(function(t) {
                        if (t = n(h, t.trim(), i)) return d(o, t, "filter", c, i, i, e),
                        !0
            ...
            _triggerDragStart: function(t, e) { (e = e || ("touch" == t.pointerType ? t: null)) ? (U = {
                    target: C,
                    clientX: e.clientX,
                    clientY: e.clientY
                },
            ...
            _onDragStart: function(t, e) {
                ...
                i = n.options;
                n._offUpEvents(),
                L.checkPull(n, n, C, t) && ((x = D(C)).draggable = !1, x.style["will-change"] = "", s(x, "display", "none"), l(x, n.options.chosenClass, !1), n._cloneId = w(function() {
                    N.insertBefore(x, C),
                    d(n, N, "clone", C)
                })),
                l(C, i.dragClass, !0),
                e ? ("touch" === e ? (r(Q, "touchmove", n._onTouchMove), r(Q, "touchend", n._onDrop), r(Q, "touchcancel", n._onDrop), r(Q, "pointermove", n._onTouchMove), r(Q, "pointerup", n._onDrop)) : (r(Q, "mousemove", n._onTouchMove), r(Q, "mouseup", n._onDrop)), n._loopId = setInterval(n._emulateDragOver, 50)) : (o && (o.effectAllowed = "move", i.setData && i.setData.call(n, o, C)), r(Q, "drop", n), r(Q, "mouseover", n), n._dragStartId = w(n._dragStarted))
            },
            _onDragOver: function(o) {
                ...
                if (void 0 !== o.preventDefault && (o.preventDefault(), !d.dragoverBubble && o.stopPropagation()), !C.animated && (H = !0, g && !d.disabled && (v ? _ || (l = !N.contains(C)) : F === this || (g.lastPullMode = L.checkPull(this, g, C, o)) && u.checkPut(this, g, C, o)) && (void 0 === o.rootEl || o.rootEl === this.el))) {
                    ...
                    if (i = n(o.target, d.draggable, c), r = C.getBoundingClientRect(), F !== this && (F = this, m = !0), l) return e(g, !0),
                    S = N,
                    ...
                    if (0 === c.children.length || c.children[0] === E || c === o.target && p(c, o)) {
                        ...
                        e(g, v),
                        !1 !== h(N, c, C, r, i, a, o) && (C.contains(c) || (c.appendChild(C), S = c), this._animate(r, C), i && this._animate(a, i))
                        ...
                        var R = h(N, c, C, r, i, a, o, O); ! 1 !== R && (1 !== R && -1 !== R || (O = 1 === R), ot = !0, J(f, 30), e(g, v), C.contains(c) || (O && !Y ? c.appendChild(C) : i.parentNode.insertBefore(C, O ? Y: i)), S = C.parentNode, this._animate(r, C), this._animate(a, i))
                    }
                }
            },
            ...
            _onDrop: function(e) {
                ...
                this.nativeDraggable && (a(Q, "drop", this), a(n, "dragstart", this._onDragStart)),
                this._offUpEvents(),
                e && (H && (e.preventDefault(), !o.dropBubble && e.stopPropagation()), E && E.parentNode && E.parentNode.removeChild(E), N !== S && "clone" === t.active.lastPullMode || x && x.parentNode && x.parentNode.removeChild(x), C && (this.nativeDraggable && a(C, "dragend", this), u(C), C.style["will-change"] = "", l(C, this.options.ghostClass, !1), l(C, this.options.chosenClass, !1), d(this, N, "unchoose", C, S, N, P), N !== S ? (R = v(C, o.draggable)) >= 0 && (d(null, S, "add", C, S, N, P, R), d(this, N, "remove", C, S, N, P, R), d(null, S, "sort", C, S, N, P, R), d(this, N, "sort", C, S, N, P, R)) : C.nextSibling !== k && (R = v(C, o.draggable)) >= 0 && (d(this, N, "update", C, S, N, P, R), d(this, N, "sort", C, S, N, P, R)), t.active && (null != R && -1 !== R || (R = P), d(this, N, "end", C, S, N, P, R), this.save()))),
                this._nulling()
            },
            _nulling: function() {
    ...
    function() {
        ...
        function t(t, e) {
            ...
            function(t) {
                ...
                var n = [];
                if (n = "A" === t.tagName ? [t] : t.getElementsByTagName("a"), 0 !== (n = [].filter.call(n,
                function(t) {
                    if ( - 1 === t.className.indexOf(e && e.ignoreClass)) return z.test(t.href)
                })).length) {
                    var a = []; [].forEach.call(n,
                    function(t, n) {
                        var o = function(t) {
        ...
        function n(t) {
            if (D.hasOwnProperty(t)) {
                var e = D[t].galleries; [].forEach.call(e,
                function(t) { [].forEach.call(t,
                    function(t) {
        ...
        function o() {
            if (N = B("baguetteBox-overlay")) return A = B("baguetteBox-slider"),
            L = B("previous-button"),
            S = B("next-button"),
            void(P = B("close-button")); (N = T("div")).setAttribute("role", "dialog"),
        ...
        function s(t, e) {
            if (M !== t) {
                ...
                V.length = 0;
                for (var n, o = [], a = [], i = 0; i < t.length; i++)(n = T("div")).className = "full-image",
                n.id = "baguette-img-" + i,
                V.push(n),
        ...
        function u(t) {
            ...
            "block" !== N.style.display && (x(document, "keydown", a), j = {
                count: 0,
                startX: null,
                startY: null
            },
        ...
        function g() {
            Y.noScrollbars && (document.documentElement.style.overflowY = "auto", document.body.style.overflowY = "auto"),
            "none" !== N.style.display && (E(document, "keydown", a), N.className = "", setTimeout(function() {
        ...
        function m(t, e) {
            var n = V[t],
            o = M[t];
            if (void 0 !== n && void 0 !== o) if (n.getElementsByTagName("img")[0]) e && e();
            else {
        ...
        function x(t, e, n, o) {
            t.addEventListener ? t.addEventListener(e, n, o) : t.attachEvent("on" + e,
            function(t) { (t = t || window.event).target = t.target || t.srcElement,
                n(t)
            })
        }
        function E(t, e, n, o) {
        ...
        Q = function(t) {++j.count > 1 && (j.multitouch = !0),
        ...
        $ = function() {--j.count <= 0 && (j.multitouch = !1),
            O = !1
        },
        _ = function() {
            $()
        ...
        n.fn.imageLightbox = function(i) {
            ...
            v = function(t) {
                ...
                if (t = "undefined" == typeof t ? !1 : "left" == t ? 1 : -1, l.length) {
                    if (t !== !1 && (o.length < 2 || i.quitOnEnd === !0 && ( - 1 === t && 0 == o.index(f) || 1 === t && o.index(f) == o.length - 1))) return E(),
                    !1;
                    var e = {
                        opacity: 0
                    };
                    r ? a(l, 100 * t - s + "px", i.animationSpeed / 1e3) : e.left = parseInt(l.css("left")) + 100 * t + "px",
                    l.animate(e, i.animationSpeed,
                    function() {
                        x()
                    }),
                    s = 0
                ...
                setTimeout(function() {
                    l = n("<img " + i.selector + " />").attr("src", f.attr("href")).on("load",
                    function() {
                        l.appendTo("body"),
                        m();
                        var e = {
                        ...
                        if (l.css("opacity", 0), r) a(l, -100 * t + "px", 0),
                        setTimeout(function() {
                        ...
                        if (l.animate(e, i.animationSpeed,
                        function() {
                            h = !1,
                    ...
                    u = 0,
                    g = 0;
                    l.on(d ? "pointerup MSPointerUp": "click",
                    function(n) {
                        if (n.preventDefault(), i.quitOnImgClick) return E(),
                        !1;
            ...
            y = function(t) {
                ...
                t.on("click.imageLightbox",
                function(t) {
                    return t.preventDefault(),
                    h ? !1 : (h = !1, i.onStart !== !1 && i.onStart(), f = n(this), void v())
                })
            };
            return n(t).on("resize", m),
            i.quitOnDocClick && n(e).on(u ? "touchend": "click",
            function(t) {
                l.length && !n(t.target).is(l) && E()
            }),
            i.enableKeyboard && n(e).on("keyup",
            function(n) {
    ...
    function(a, b) {
        ...
        c.prototype = {
            ...
            fit: function(a) {
                ...
                f = e > 0 ? a[0].h: 0;
                for (this.root.h = f, b = 0; b < e; b++) d = a[b],
        ...
        b.fn.filterizr.prototype = {
            init: function(a, c) {
                ...
                d._uID = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
                function(a) {
            ...
            toggleFilter: function(a) {
                ...
                b._multifilterModeOn() ? (c = b._makeMultifilterArray(), b._handleFiltering(c), b._isSearchActivated() && b.search(b._typedText)) : (b.filter("all"), b._isSearchActivated() && b.search(b._typedText))
            },
            search: function(a) {
                var b = this,
            ...
            setOptions: function(a) {
                ...
                a.callbacks && (a.callbacks.onFilteringStart || (b.options.callbacks.onFilteringStart = function() {}), a.callbacks.onFilteringEnd || (b.options.callbacks.onFilteringEnd = function() {}), a.callbacks.onShufflingStart || (b.options.callbacks.onShufflingStart = function() {}), a.callbacks.onShufflingEnd || (b.options.callbacks.onShufflingEnd = function() {}), a.callbacks.onSortingStart || (b.options.callbacks.onSortingStart = function() {}), a.callbacks.onSortingEnd || (b.options.callbacks.onSortingEnd = function() {})),
            ...
            _makeSubarrays: function() {
                for (var a = this,
                b = [], c = 0; c < a._lastCategory; c++) b.push([]);
            ...
            _calcItemPositions: function() {
                ...
                if ("horizontal" === a.options.layout) for (g = 1, l = 1; l <= d.length; l++) h = d[l - 1].outerWidth(),
                i = d[l - 1].outerHeight(),
                n.push({
                    left: j,
                    top: k
                ...
                e < i && (e = i);
                    ...
                    for (l = 1; l <= d.length; l++) i = d[l - 1].outerHeight(),
                    n.push({
                        left: j,
                        top: k
                    }),
                    ...
                    for (l = 1; l <= d.length; l++) {
                        ...
                        m = j + h + r,
                        m > p ? (m = 0, j = 0, k += d[0].outerHeight(), g++) : j += q
                    }
                    e = g * d[0].outerHeight()
                    ...
                    for (l = 1; l <= d.length; l++) {
                        if (n.push({
                            left: j,
                            top: k
                        }), l % f == 0 && g++, j += h, k = 0, g > 0) for (m = g; m > 0;) k += d[l - f * m].outerHeight(),
                        m--;
                        l % f == 0 && (j = 0)
                    }
                    for (l = 0; l < f; l++) {
                        for (var s = 0,
                        t = l; d[t];) s += d[t].outerHeight(),
                        t += f;
                        s > e ? (e = s, s = 0) : s = 0
                    }
            ...
            _handleFiltering: function(a) {
                for (var b = this,
                c = b._getArrayOfUniqueItems(b._activeArray, a), d = 0; d < c.length; d++) c[d]._filterOut();
                b._activeArray = a,
                b._placeItems(a)
            },
            ...
            _getArrayOfUniqueItems: function(a, b) {
                ...
                for (e = a.length, f = 0; f < e; f++) g = a[f],
            ...
            _fisherYatesShuffle: function(b) {
                for (var d, e, c = b.length; c;) e = Math.floor(Math.random() * c--),
                d = b[c],
                b[c] = b[e],
                b[e] = d;
                return b
        ...
        var d = {
            _init: function(a, b) {
                ...
                c.on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",
                function() {
                    c._onTransitionEnd()
                }),
                c
            ...
            _onTransitionEnd: function() {
                var a = this;
                a._filteringOut ? (b(a).addClass("filteredOut"), a._isFilteredOut = !0, a._filteringOut = !1) : a._filteringIn && (a._isFilteredOut = !1, a._filteringIn = !1),
                a._parent._isAnimating && (a._parent._isShuffling ? a._parent.trigger("shufflingEnd") : a._parent._isSorting ? a._parent.trigger("sortingEnd") : a._parent.trigger("filteringEnd"), a._parent._isAnimating = !1)
            },
            _filterOut: function() {
                var a = this,
    ...
    function(e) {
        ...
        e.fn.readingTime = function(i) {
            ...
            t, i);
            var s = r.settings;
            if (!this.length) return s.error.call(this),
            this;
            ...
            return a.each(function() {
                null != s.remotePath && null != s.remoteTarget ? e.get(s.remotePath,
                function(n) {
