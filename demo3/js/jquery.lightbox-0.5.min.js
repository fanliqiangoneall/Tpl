 ...
 */
(function($){$.fn.lightBox=function(settings){settings=jQuery.extend({overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'/Tpl/demo3/img/lightbox-ico-loading.gif',imageBtnPrev:'/Tpl/demo3/img/lightbox-btn-prev.gif',imageBtnNext:'/Tpl/demo3/img/lightbox-btn-next.gif',imageBtnClose:'/Tpl/demo3/img/lightbox-btn-close.gif',imageBlank:'/Tpl/demo3/img/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
