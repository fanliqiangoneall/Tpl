require(['jquery'], function ($) {
    ...
    var offsetTop = $(".head-7__bar__navigation").offset().top;
    var offsetTop_mobile = $(".head-7__bar__box--mobile").offset().top;
    ...
    /*pc seacrch*/
    $(".head-7_search a").click(function(){
        $(this).toggleClass("active");
        $(this).next(".head-7_search_wrap").toggleClass("active");
    });
	$(".head-7_weixin").hover(function(){
		$(this).children(".head-7_weixin_img").fadeIn();
	},function(){
		$(this).children(".head-7_weixin_img").fadeOut();
	});
