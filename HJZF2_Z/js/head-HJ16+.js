...
$(document).ready(function(e) {
    $(".hj_navbar_nav_dropdown-menu").each(function(index, element) {
        $(this).parent().find(".next-level-button").show();	
    });
    ...
    $(".next-level-button").click(function (event) {
		event.preventDefault();
        $(this).toggleClass("active");
        $(this).parent().next(".hj_navbar_nav_dropdown-menu").slideToggle();
    });
    /* 阴影层点击 */
