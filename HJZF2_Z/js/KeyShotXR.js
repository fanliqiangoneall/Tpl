...
window.keyshotXR = function(U, v, V, W, pa, D, qa, ra, sa, ta, ua, J, K, X, Y, va, Z, wa, $, xa, aa, ya, za, Aa, Ba, p ,iconbg,iconwidth,loadingwidth) {
    ...
    this.Ua = function() {
        a.u(!a.l);
        a.l ? a.H.setAttribute("src",  "/www/Tpl/public/image/GoFullScreenIcon.png") : a.H.setAttribute("src",  "/www/Tpl/public/image/GoFixedSizeIcon.png");
	};
    this.u = function(b) {
        a.l = b;
    ...
    this.ta = function() {
        ...
        a.o.innerHTML = '<img src="/www/Tpl/public/image/'  + c + '"></img>';
        a.p.appendChild(a.o);
        a.p.appendChild(a.Q);
        n.appendChild(a.p);
        a.u(a.l);
