...
jQuery('#index_navigation_animate').removeClass().addClass('fadeIn');
        ...
        <div class="in_banner" style="background:url(__TMPL__demo2/img/inbanner4.jpg) center no-repeat"></div>


    <div class="r_mbx"><img src="__TMPL__demo2/img/in_home.jpg" border="0" style="vertical-align:middle;" />&nbsp;<a href="<?php echo U('/');?>">Home</a>&nbsp;>&nbsp;Custom Bottles</div>
  ...
  <div class="subNavBox" style="width: 263px;">
    ...
    <div style="text-align: center;margin-top: 15px;">
     <a href="<?php echo U('/contactus');?>"><img src="__TMPL__demo2/img/contact.jpg" style="width: 226px;"></a>
        ...
        <div class="page_Main">
            <div class="page_RightTitle"><span>Custom Bottles</span></div>
            <div class="clear"></div>
            <div class="page_RightMain">
                <div class="news">
                    <div class="body">

                        <div class="show_product_list" style="margin-top: 23px;">
                            <ul>
                      ...
                      <div class="incase_pic"><a href="<?php echo U('/case_detail',array('nid'=>$allnews["nid"]));?>"><?php if($allnews['new_pro'] != ''): ?><img src="<?php echo getimgurl($allnews['new_pro']);?>" border="0" alt="<?php echo ($allnews['title']); ?>" /><?php else: ?><img src="__TMPL__demo2/img/case_pic.jpg" border="0" /><?php endif; ?></a></div>
                      <div class="incase_name">
                         ...
                         <li style="margin-bottom: 10px;"><a href="<?php echo U('/case_detail',array('nid'=>$allnews["nid"]));?>" style="font-size: 22px;color: #333333;line-height: 30px;"><?php echo ($allnews['title']); ?></a></li>
