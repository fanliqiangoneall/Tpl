...
<?php if($banner != ''): if(is_array($banner)): $i = 0; $__LIST__ = array_slice($banner,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$banner): $mod = ($i % 2 );++$i;?><div class="in_banner" style="background:url(<?php echo getimgurl($banner['ad_pic']);?>) center no-repeat"></div><?php endforeach; endif; else: echo "" ;endif; ?>
        <?php else: ?>
        <div class="in_banner" style="background:url(__TMPL__demo2/img/inbanner1.jpg) center no-repeat"></div><?php endif; ?>
<div class="r_mbx"><img src="__TMPL__demo2/img/in_home.jpg" border="0" style="vertical-align:middle;" />&nbsp;<a href="<?php echo U('/');?>">Home</a>&nbsp;>&nbsp;Exhibitton&gt;&gt;&nbsp;<?php echo ($news['title']); ?></div>
...
<div class="left_title2" style="margin-top: 40px;">
  ...
  <div class="page_Main"> 
    <div class="page_RightTitle"><span><?php echo ($news['title']); ?></span></div>
<div id="newsdetailshow">
  <div class="message">
   <span class="date" style="text-align:center; float:none;"><em>Date: </em><?php echo date('m/d/Y',$news['created']);?>
   </span>
	</div>           
  <div class="summary" style="margin-top: 30px;">
   </div>
  <div class="describe htmledit edit" id="infoContent">
