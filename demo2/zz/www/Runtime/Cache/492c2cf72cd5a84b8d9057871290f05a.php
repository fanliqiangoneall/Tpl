...
<div class="r_mbx"><img src="__TMPL__demo2/img/in_home.jpg" border="0" style="vertical-align:middle;" />&nbsp;<a href="<?php echo U('/');?>">Home</a>&nbsp;>&nbsp;Products</div>
...
<div class="page_Main">
    <div class="page_RightTitle">Products center</div>
    <div class="page_RightMain" style="padding-bottom:20px;">
      <?php if(is_array($allpro)): $i = 0; $__LIST__ = $allpro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$allpro): $mod = ($i % 2 );++$i;?><div class="asd2">
                <div class="img2" ><a href="<?php echo U('/Product','','');?>/<?php echo getproname($allpro['pid']);?>"><img src="<?php echo getpcimgurl($allpro['main_img']);?>" <?php if($allpro['proalt'] != ''): ?>alt="<?php echo ($allpro['proalt']); ?>"<?php else: ?>alt="<?php echo ($allpro['pro_name']); ?>"<?php endif; ?> /></a>
                </div>
                  <div class="in_proname2">
                   <a href="<?php echo U('/Product','','');?>/<?php echo getproname($allpro['pid']);?>"><?php echo ($allpro['pro_name']); ?></a>
                </div>
              </div>
            <?php if(($key+1)%3 == 0): ?><div style="clear:both; width: 100%; height:39px;"></div>
          <?php else: ?>
              <div style="width:33px; height:10px; background:none; float:left;"></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>  
