...
<div class="r_mbx"><img src="__TMPL__demo2/img/in_home.jpg" border="0" style="vertical-align:middle;" />&nbsp;<a href="<?php echo U('/');?>">Home</a>&nbsp;>&nbsp;News</div>

<!--<div class="page_LeftClass">
   <ul>
      <?php if(is_array($navrs)): $i = 0; $__LIST__ = $navrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$allclass_left): $mod = ($i % 2 );++$i;?><li <?php if($intro_class['classid'] == $allclass_left['introclassid']): ?>class="parent1"<?php else: ?>class="parent"<?php endif; ?>><a href="<?php echo ($allclass_left['url']); ?>"><?php echo ($allclass_left['title']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
   </ul>
   <div class="clear"></div>
</div>-->
...
.subNav:hover{
 width: 213px;margin: 0px auto;margin-bottom: 20px;
}
.subNav:hover h3{
...
.subNavon{
  width: 213px;margin: 0px auto;background:#66bfb1;margin-bottom: 20px;padding-left: 13px}
...
<div class="left_title2" style="margin-top: 40px;">
  ...
  <div class="subNavBox" style="width: 263px;">
    <div style="width: 220px;margin: auto;">
     <li style="font-size: 16px;line-height: 30px;">Manager: <?php echo ($about['contact']); ?></li>
     <li style="font-size: 16px;line-height: 30px;">
       Tel: <?php echo chaifen($about['mobile'],0);?>
     </li>

     <li style="font-size: 16px;line-height: 30px;">
       <span>Email: </span><span><a href="mailto:<?php echo chaifen($about[email],0);?>" onclick="turn_sta(3,4);gtag_report_conversion_email();" style="color:#333333"><?php echo chaifen($about['email'],0);?></a></span>
     </li>
    </div>
...
<div class="page_Main">
  <div class="page_RightTitle"><span>NEWS</span></div>
  <div class="body" style="margin-top: 45px;">
             <?php if(is_array($allnews)): $k = 0; $__LIST__ = $allnews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$allnews): $mod = ($k % 2 );++$k;?><div class="in_case">
                      <div class="incase_pic"><a href="<?php echo U('/new_detail',array('nid'=>$allnews["nid"]));?>"><?php if($allnews['new_pro'] != ''): ?><img src="<?php echo getimgurl($allnews['new_pro']);?>" border="0" alt="<?php echo ($allnews['title']); ?>" /><?php else: ?><img src="__TMPL__demo2/img/case_pic.jpg" border="0" /><?php endif; ?></a></div>
                      <div class="incase_name">
                         <li style="float: left;color: #999;font-size: 16px;line-height: 28px;margin-bottom: 10px"><?php echo date('Y.m.d',$allnews['created']);?></li>
                         <li style="margin-bottom: 10px;"><a href="<?php echo U('/new_detail',array('nid'=>$allnews["nid"]));?>" style="font-size: 22px;color: #333333;line-height: 30px;"><?php echo ($allnews['title']); ?></a></li>
                         <li style="color: #999;font-size: 16px;line-height: 28px;"><?php echo subtxt($allnews['news_description'],100);?></li>
                      </div>  
                  </div>
                  <?php if($k % 3 != 0): ?><div style="width:32px; float:left; height:30px;"></div>
                  <?php else: ?>
                     <div style="clear:both"></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
          </div>
...
jQuery(document).ready(function(){
  jQuery(".sidebar ul li").hover(function(){
    jQuery(this).find(".sidebox").stop().animate({"width":"310px"},200).css({"opacity":"1","filter":"Alpha(opacity=100)","background":"#69c4b3"})
    jQuery(this).find(".sidebox2").stop().animate({"width":"260px"},200).css({"opacity":"1","filter":"Alpha(opacity=100)","background":"#69c4b3"})
    jQuery(this).find(".sidebox3").stop().animate({"width":"260px"},200).css({"opacity":"1","filter":"Alpha(opacity=100)","background":"#69c4b3"})
  },function(){
...
<div class="sidebar">
  <ul>
    <li style="height:61px"><div class="sidebox2"><a href="<?php echo U('/');?>"><img src="__TMPL__demo2/img/whats.png" border="0" style="margin-top: 5px;margin-left: 5px;"></a></div></li>
    <li style="height:61px;"><div class="sidebox2"><a href="skype:<?php echo chaifen($about['msn'],0);?>?chat" onclick="turn_sta(4,4);gtag_report_conversion_skype();" style="color:#fff"><img src="__TMPL__demo2/img/r_skype.png" border="0"></a></div></li>
    <li style="height:61px"><div class="sidebox2"><a href="mailto:<?php echo chaifen($about[email],0);?>" onclick="turn_sta(3,4);gtag_report_conversion_email();" style="color:#fff"><img src="__TMPL__demo2/img/r_email.png" border="0"><?php echo chaifen($about['email'],0);?></a></div></li>
    <!--<li>
...
.sidebar ul li .sidebox{position:absolute;width:60px; height:60px;top:0;right:0;transition:all 0.3s;background:#69c4b3;overflow:hidden;color:#fff; font-size:14px;}
.sidebar ul li .sidebox1{position:absolute;width:60px; height:60px;top:0;right:0;transition:all 0.3s;background:#69c4b3;overflow:hidden;color:#fff; font-size:14px;}
.sidebar ul li .sidebox1:hover{ background:#69c4b3;}
.sidebar ul li .sidebox2{position:absolute;width:60px; height:60px;top:0;right:0;transition:all 0.3s;background:#69c4b3;overflow:hidden;color:#fff; font-size:14px;}
.sidebar ul li .sidebox3{position:absolute;width:60px; height:60px;top:0;right:0;transition:all 0.3s;background:#69c4b3;overflow:hidden;color:#fff; font-size:14px;}
.wx-container {width: 60px; height: 60px;background: url(__TMPL__demo2/img/r_ewm.png) no-repeat #69c4b3;float:left;}
