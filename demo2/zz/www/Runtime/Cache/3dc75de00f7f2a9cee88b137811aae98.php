...
<div class="r_mbx"><img src="__TMPL__demo2/img/in_home.jpg" border="0" style="vertical-align:middle;" />&nbsp;<a href="<?php echo U('/');?>">Home</a>&nbsp;>&nbsp;Inquiry</div>

<div class="page_Main">
    <div class="page_RightTitle">Inquiry</div>
    <div class="page_RightMain">
      <table width="500" border="1" align="center" cellpadding="3" cellspacing="0" style="margin:0 auto">
       <tr>
        <th align="center" bgcolor="#cccccc">MESSAGE</th>
       </tr>
       <tr>
        <td align="center"> 
         <br />
         <?php if(isset($message)): echo ($message); ?><br /><?php endif; ?>
         <?php if(isset($error)): echo ($error); ?><br /><?php endif; ?>
      <p class="detail"></p>
      <p class="jump" style=" text-align:center;">
      <a id="href" href="<?php echo($jumpUrl); ?>">Click to return to the previous page</a> Wait time: <b id="wait">5</b>
      </p><br /></td>
       </tr>
      </table>
<script type="text/javascript">
