...
<?php if($navparentid == 8781): ?><script>
jQuery(document).ready(function (){
  $('#menu2').removeClass().addClass("menuon");
})
</script>
<?php elseif($navparentid == 8782): ?>
<script>
jQuery(document).ready(function (){
  jQuery('#menu4').removeClass().addClass("menuon");
})
</script>
<?php elseif($navparentid == 8783): ?>
<script>
jQuery(document).ready(function (){
  jQuery('#menu6').removeClass().addClass("menuon");
})
</script><?php endif; ?>
...
<div class="page_LeftClass">
  <div class="left_title3">
     <?php echo ($intro_class['class_name']); ?>
  </div>
  <div class="subNavBox">
     <?php if(is_array($navrs)): $i = 0; $__LIST__ = $navrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$allclass_left): $mod = ($i % 2 );++$i;?><div <?php if(inthiscate($classid,$allclass_left['pcid'],$product)): ?>class="subNavon"<?php else: ?>class="subNav"<?php endif; ?>><a href="<?php echo ($allclass_left['url']); ?>"><?php echo ($allclass_left['title']); ?></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="page_Main">
   ...
   <div class="page_RightTitle"><span><?php echo ($intro_class['class_name']); ?></span></div>
   <div class="page_RightMain" id="payment"><?php echo htmlspecialchars_decode($intro_class['readme']);?></div>
