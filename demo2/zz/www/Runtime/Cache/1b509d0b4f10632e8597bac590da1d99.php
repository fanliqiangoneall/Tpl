...
<div class="r_mbx"><img src="__TMPL__demo2/img/in_home.jpg" border="0" style="vertical-align:middle;" />&nbsp;<a href="<?php echo U('/');?>">Home</a>&nbsp;>&nbsp;404</div>
...
<div class="page_Main">
  <div class="page_RightTitle"><span>404</span></div>
  <div class="page_RightMain" style="text-align:center;"><a href="<?php echo U('/');?>"><img src="__TMPL__demo2/img/404.gif" border="0" alt="404" /></a></div>
...
<div class="index_bottom_footer">
 ...
 <?php if($friend_link != ''): ?><div class="friendlink" style="margin-top: 0px;">
            <div class="link"><span style="font-size:14px; font-weight:bold; float:left;line-height:30px;color: #333">FriendLink: </span>
