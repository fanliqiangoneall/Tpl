...
<div class="context">首页 > <?php echo ($download['title']); ?></div>
...
<div class="context">
<h1 ><?php echo ($download['title']); ?><font style="margin-left:5px;color:#999;"><?php echo date("Y-m-d",$download['update_time']);?></font></h1>
<div class="newsinfo"><?php echo htmlspecialchars_decode($download['content']);?></div>
</div>
