...
<div class="r_mbx"><img src="__TMPL__demo2/img/in_home.jpg" border="0" style="vertical-align:middle;" />&nbsp;<a href="<?php echo U('/');?>">Home</a>&nbsp;>&nbsp;<?php echo ($newclass['class_name']); ?></div>
...
<div class="page_Main">
    <div class="page_RightMain">
      ...
      <div id="news_detail">
        <div class="body">
          <h1 class="fc_107fd0 fs_16 bold"><?php echo ($news['title']); ?></h1>
          <div class="news_view"><span class="right red">View:<?php echo ($news['click_num']); ?></span><span class="right time"><?php echo date('m/d/Y',$news['created']);?>&nbsp;&nbsp;</span></div>
          <div class="clear"></div>
          <div class="news_body"><?php echo htmlspecialchars_decode($news['body']);?></div>
          <div class="bt" style="margin-top:22px;"><a href="javascript:history.back()" onfocus="blur()" style="display:block; font-size:14px; text-align:center; line-height:35px; color:#fff;">Back</a></div>
        </div>
      </div>
    </div>
