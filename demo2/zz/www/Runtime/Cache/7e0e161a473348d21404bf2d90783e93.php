...
<script>
$(document).ready(function () {
	$('#menu5').removeClass().addClass("menuon1");
});
</script>
<div><img src="__TMPL__WAP/img/in_contact.jpg" border="0" width="100%" /></div>
<div data-role="content" style="padding-top:15px;">
  ...
  <div class="lmtitle"><?php echo ($intro_class['class_name']); ?></div>
  <div style="width:100%; height:10px;"></div>
  <div class="page_main">
  <?php echo htmlspecialchars_decode($intro_class['readme']);?>
  <?php echo htmlspecialchars_decode(get_contactus_code());?>
  </div>
</div>
