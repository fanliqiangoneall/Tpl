  ...
  <div class="subNavBox" style="width: 263px;">
    ...
    <div style="text-align: center;margin-top: 15px;">
     <a href="<?php echo U('/contactus');?>"><img src="__TMPL__demo2/img/contact.jpg" style="width: 226px;"></a>
           ...
           <div class="page_Main">
              <div class="page_RightTitle"><span><?php echo ($prolist['class_name']); ?></span></div>
              <div style="font-size: 16px;padding-bottom: 20px; padding-top: 20px;">
                <?php echo str_replace('&nbsp;',' ',htmlspecialchars_decode($prolist['cate_profile']));?>
              </div>
