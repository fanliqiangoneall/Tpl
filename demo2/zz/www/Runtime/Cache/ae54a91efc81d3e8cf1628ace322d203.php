...
<!--面包屑代码块开始-->
<div class="r_top">Current Position : <a href="<?php echo U('/');?>">Home</a> > <a href="/inquiry.html">INQUIRY</a></div>
...
<div class="main">
    ...
    <div class="Page_Leftbg">
      ...
      <div class="Page_LeftClass">
        ...
        <div class="Page_LeftClassList">
          <ul>
            <li style="height:1px; line-height:1px; background:url(/sites/all/themes/baixing/images/leftline.jpg)"></li>
            <?php if(is_array($allclass)): $i = 0; $__LIST__ = $allclass;if( count($__LIST__)==0 ) : echo "No Content" ;else: foreach($__LIST__ as $key=>$allclass): $mod = ($i % 2 );++$i;?><li class="parent"><a href="<?php echo U('/Product_category',getprocatename($allclass['pcid']));?>"><?php echo ($allclass['class_name']); ?></a></li><?php endforeach; endif; else: echo "No Content" ;endif; ?>
          </ul>
        </div>
      </div>
  ...
  <div class="rightmain">
    <div class="rightlm">INQUIRY</div>
    <div class="product_body2">
      <div class="body" style="width:630px; padding-left:5px; float:left;line-height:24px;"> <style>
body{font-size:12px;}
