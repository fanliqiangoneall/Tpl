...
<div data-role="content" style="padding-top:15px;">
    <div class="main_top"><a href="<?php echo U('/');?>">Home</a>&nbsp;>&nbsp;Products</div>
    <div class="lmtitle">Products</div>
    <div style="width:96%; padding:2%; height:auto;">
      <?php if(is_array($allclass)): $i = 0; $__LIST__ = $allclass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$allclass_left): $mod = ($i % 2 );++$i;?><a data-ajax="false" href="<?php echo U('/product_category','','');?>/<?php echo getprocatename($allclass_left['pcid']);?>">
            <div class="classname"><?php echo ($allclass_left['class_name']); ?></div>
            </a>
            <?php if(is_array($allclass_left['childs'])): $i = 0; $__LIST__ = $allclass_left['childs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$onechild): $mod = ($i % 2 );++$i;?><div class="classname1"><a href="<?php echo U('/product_category','','');?>/<?php echo getprocatename($onechild['pcid']);?>"><?php echo ($onechild['class_name']); ?></a></div><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
    </div>
